...
const { authorDetails, firstName, lastName, occupation, bio, topics } =
  placeholders;
...
export default function decorate(block) {
  ...
  let fn = document.createElement("th");
  fn.appendChild(document.createTextNode(firstName));
  tr.append(fn);
  let ln = document.createElement("th");
  ...
  tr.append(oc);
  let bi = document.createElement("th");
